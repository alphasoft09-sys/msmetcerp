...
<head>
    ...
    <meta name="description" content="Student Reset Password - MSME Technology Centre, Government of India">
    ...
    <title>Student Reset Password | MSME Technology Centre | Government of India</title>
...
<body>
    ...
    <div class="student-banner">
        <i class="fas fa-graduation-cap"></i> STUDENT PASSWORD RESET
    ...
    <main id="main-content" class="page-transition">
        <x-clean-form-layout 
            ...
            subtitle="Create a new secure password for your student account"
            :formAction="route('student.password.update')"
            :showBackLink="true"
