...
<head>
    ...
    <title>Student Login - {{ env('PROJECT_NAME', 'MSME Technology Center') }}</title>
    ...
    <div class="login-container">
        <div class="login-card">
            <div class="card-body">
                ...
                <form id="studentLoginForm" method="POST" action="{{ route('student.login') }}">
                    @csrf
                ...
                <div class="text-center mb-3">
                    <a href="{{ route('student.password.request') }}" class="btn-link">
