...
<head>
    ...
    <meta name="description" content="Forgot Password - MSME Technology Centre, Government of India">
    <meta name="keywords" content="MSME, Government of India, Password Reset, Technology Centre">
    ...
    <title>Forgot Password | MSME Technology Centre | Government of India</title>
...
<body>
    ...
    <div class="admin-banner">
        <i class="fas fa-shield-alt"></i> ADMINISTRATOR PASSWORD RECOVERY
    ...
    <main id="main-content" class="page-transition">
        <div class="goi-login-container" style="flex: 1 0 auto;">
            ...
            <div class="goi-login-left">
                ...
                <div class="steps-container">
                    <div class="step">
                        ...
                        <div class="step-content">
                            ...
                            <div class="step-description">Provide the email address associated with your admin account.</div>
                        </div>
                    </div>
                    <div class="step">
                ...
                <div style="margin-top: 1.5rem; text-align: center;">
                    <p style="font-size: 0.75rem; color: var(--gray-600);">
                        Need help? Contact <a href="mailto:support@msme.gov.in" style="color: var(--primary-red);">support@msme.gov.in</a>
                    </p>
                </div>
            </div>
            ...
            <div class="goi-login-right">
                <img src="https://images.unsplash.com/photo-1522071820081-009f0129c71c?w=600&h=400&fit=crop&crop=center" alt="Password Recovery">
                
                <!-- Chat Bubble -->
                <div class="chat-bubble">
                    <strong>Forgot password?</strong>
                    <p style="margin-top: 0.25rem;">Follow the steps to reset your account access.</p>
                </div>
            </div>
        </div>
    </main>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function showFieldErrors(errors) {
                ...
                if (errorList.length > 0) {
                    ...
                    let container = document.querySelector('.goi-notification-container');
                    if (!container) {
                        container = document.createElement('div');
                        container.className = 'goi-notification-container';
        ...
        // Global notification function (used by the form)
