...
<head>
    ...
    <meta name="description" content="Admin Forgot Password - MSME Technology Centre, Government of India">
    ...
    <title>Admin Forgot Password | MSME Technology Centre | Government of India</title>
...
<body>
    ...
    <div class="admin-banner">
        <i class="fas fa-shield-alt"></i> ADMIN PASSWORD RECOVERY
    ...
    <main id="main-content" class="page-transition">
        <x-clean-form-layout 
            ...
            :formAction="route('admin.password.email')"
            :showBackLink="true"
