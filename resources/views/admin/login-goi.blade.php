            ...
            <div class="goi-login-card">
                ...
                <form id="loginForm" action="{{ route('admin.login') }}" method="POST">
                    ...
                    <div class="goi-form-group-clean">
                        <label for="email" class="goi-form-label-clean">Email Address</label>
                        <input 
                            type="email" 
                            id="email" 
                            name="email" 
                    ...
                    <!-- Password Field -->
                    <div class="goi-form-group-clean">
                        <label for="password" class="goi-form-label-clean">Password</label>
                        <input 
                            type="password" 
                            id="password" 
                            name="password" 
                    ...
                    <div class="goi-form-options">
                        ...
                        <a href="{{ route('admin.password.request') }}" class="goi-forgot-link">Forgot Password?</a>
                    </div>
