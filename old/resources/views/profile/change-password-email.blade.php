...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const sendOtpRoute = isStudent ? '{{ route("student.profile.send-otp") }}' : '{{ route("admin.profile.send-otp") }}';
    const verifyUpdateRoute = isStudent ? '{{ route("student.profile.verify-update") }}' : '{{ route("admin.profile.verify-update") }}';
    ...
    // Handle form submission (OTP verification and update)
        ...
        .then(data => {
            ...
            if (data.success) {
                ...
                if (data.logout_required) {
                    ...
                    setTimeout(() => {
                        const logoutRoute = isStudent ? '{{ route("student.logout") }}' : '{{ route("admin.logout") }}';
