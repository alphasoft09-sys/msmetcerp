                    ...
                    <div class="mb-4">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" value="{{ $user->tc_code ?? 'N/A' }}" readonly>
                            </div>
                        </div>
                    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Student routes
    const sendOtpRoute = '{{ route("student.profile.send-otp") }}';
    const verifyUpdateRoute = '{{ route("student.profile.verify-update") }}';
