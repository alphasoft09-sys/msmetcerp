...
<head>
    ...
    <title>Exam Schedule Approved by Exam Cell</title>
    <style>
        body {
...
<body>
    <div class="header">
        <h1>✅ Exam Schedule Approved by Exam Cell</h1>
        <p>Action Required: TC Head Review</p>
    </div>
    
    <div class="content">
        <p>Dear <strong>{{ $tcHeadUser->name }}</strong>,</p>
        
        <p>An exam schedule has been approved by the Exam Cell and is now ready for your review and approval.</p>
        ...
        <div class="details">
            ...
            <ul>
                ...
                <li><strong>Approved By:</strong> {{ $examCellUser->name }} (Exam Cell)</li>
        ...
        <p style="text-align: center;">
            <a href="{{ url('/admin/tc-head/exam-schedules/' . $examSchedule->id) }}" class="button">
        ...
        <div class="footer">
            ...
            <ul>
                ...
                <li>Contact the Exam Cell if any clarification is needed</li>
